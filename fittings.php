        ...
        <div class="container py-4">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0 animate-on-scroll">
                    <img src="assets/images/fittings_hero.png" class="img-fluid rounded shadow w-100 object-fit-cover" style="height: 400px;" alt="Pipe Fittings">
                </div>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-md-6 animate-on-scroll">
                    <img src="assets/images/gallery_26.jpeg" class="img-fluid rounded shadow-sm w-100 object-fit-cover" style="height: 300px;" alt="Pipe Fittings Showcase 1">
                </div>
                <div class="col-md-6 animate-on-scroll delay-1">
                    <img src="assets/images/gallery_27.jpeg" class="img-fluid rounded shadow-sm w-100 object-fit-cover" style="height: 300px;" alt="Pipe Fittings Showcase 2">
                </div>
            </div>
        </div>
    </section>
